...
@Autonomous(name = "Exit red goal side", group = "Autonomous")
@Configurable // Panels
public class ExitRedSide extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(123.133, 122.801, Math.toRadians(38)));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Path1 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(123.133, 122.801),
                                    new Pose(100.924, 100.615),
                                    new Pose(90.191, 66.447)
                            )
