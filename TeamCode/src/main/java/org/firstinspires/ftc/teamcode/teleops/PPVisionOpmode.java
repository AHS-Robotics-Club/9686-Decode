    ...
    public class PPVisionOpmode extends CommandOpMode {
        ...
        public void initialize() {
            ...
            follower.setStartingPose(RobotConstraints.teleOpStartPose);
...
//                    .whenPressed(() -> scheduleMotif());
            ...
            limelight.switchMotifDetection();
        }
    ...
    //            turret.update(hasLL, tx, headingVel, robotHeading);
                ...
                turret.updateVision(tx, result != null);
    
    
                goalDisplacementX = Math.abs(follower.getPose().getX() - (RobotConstraints.redGoal.getX()));
                goalDisplacementY = Math.abs(follower.getPose().getY() - (RobotConstraints.blueGoal.getY()));
        ...
        // if (gamepad1.dpad_right) turret.spinRight();
            ...
            if (gamepad1.left_trigger != 0 && (gamepad1.dpad_left || gamepad1.dpad_down) && totalBalls > 0) {
...
//                            limelight.switchPipelineRed();
            ...
            telemetry.addData("Was detected", motifIDdetected);
            ...
            telemetry.addData("BotPose X: ", follower.getPose().getX());
            telemetry.addData("BotPose Y: ", follower.getPose().getY());
            telemetry.addData("Bot Heading", Math.toDegrees(follower.getHeading()));
    
            telemetry.addData("Starting pose", RobotConstraints.teleOpStartPose);
    
            telemetry.addData("Starting Heading", Math.toDegrees(RobotConstraints.teleOpStartPose.getHeading()));
    
            telemetry.addData("Angles to rotate to goal", turret.targetRotation());
